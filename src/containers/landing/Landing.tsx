...
import { NewFeaturesBar }  from '../../components/exports';
...
const Landing = () => {
 ...
 useEffect(():any=>{
  ...
  return ()=> typed ? typed.destroy() : null;
 }, [writing])
  ...
  return (
    ...
    <div className='app__landing-flex'>
      <div className='app__landing_img'>
        <img className="app__landing_img--img" src={landing}/>
      </div>
      <div className='app__landing__main'>
  
      <div className='app__landing__main-container'>
      <h2>Undertale Blue Project Presents:</h2>
       <h1>A new History <span ref={writing}></span></h1>
       <div>
       <h2>Get ready for the friendlier travel you will ever do in a game</h2>
       </div>
